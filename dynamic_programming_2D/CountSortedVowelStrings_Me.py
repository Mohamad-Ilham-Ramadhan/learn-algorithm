"""
	(2D dynamic programming) Leetcode: 1641. Count Sorted Vowel Strings (medium)
	...
	Submissions: 
		#1 brute-force O(n^2)
			runtime: 2969 ms, beats 17.25%
			memory: 16.30 MB, beats 42.45%
      #2 dynamic programming
			runtime: 43 ms, beats 62.02%
			memory: 16.02 MB, beats 72.48%
...
# print('RESULT: ', countVowelStrings(7))
